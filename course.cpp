...
void glstudent();
void findStudent();
void chanStundentPassword();
void chooseCourse();
void creatChosenCourse();
void findCourse();
void changeCourse();
void creatCourse();
...
A:
    ...
    {
        cout << "\n\t\t          课程名:" << p1->name << " 课程号:" << p1->num << " 开课教师:" << p1->cteacher
             << " 课余量:" << p1->sum;
    }
    int ji = 0;
...
void creatChosenCourse()
{
    ...
    for (int i = 0; i < stu->kyl; i++)
    {
        ...
        {
            if (stu->course[i] == p->num)
                cout << "课程名:" << p->name << " 课序号:" << p->num << " 开课教师:" << p->cteacher
                     << " 课容量:" << p->sum << endl;
        }
    }
n:
    ...
    if (x == '1')
    {
        ...
        for (i = head1; i != NULL; i = i->next)
        {
            if (s == i->num)
            {
                ...
                cout << "\n\t\t\t      找到该课程！\n";
                f = 1;
                cout << "课程名:" << i->name << " 课程号:" << i->num << " 开课教师:" << i->cteacher
                     << " 课容量:" << i->sum;
            n:
                cout << "\n\t\t      继续查询输入Y，返回课程管理输入N";
                cout << "\t\t              请输入:";
...
A:
    ...
    if (a == '1')
    {
        ...
        cout << "\n姓名:" << p->name << " 学号:" << p->id << " 性别:" << p->sex << endl;
        cout << "\n\t\t   该学生选课结果\n";
        for (int i = 0; i < p->kyl; i++)
        {
            for (q = head1; q != NULL; q = q->next)
            {
                if (p->course[i] == q->num)
                {
                    cout << "课程名:" << q->name << " 课程号:" << q->num << " 开课教师:" << q->cteacher
                         << " 课容量:" << q->sum << endl;
                }
            }
        }
